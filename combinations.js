// Pastikan CombinationTypes hanya dideklarasikan sekali
if (typeof window.CombinationTypes === 'undefined' && !Object.prototype.hasOwnProperty.call(window, 'CombinationTypes')) {
    Object.defineProperty(window, 'CombinationTypes', {
        value: {
            SINGLE: 'single',
            TRIPLET: 'triplet',
            QUARTET: 'quartet',
            ...
            validate: function(combinationType, cards) {
                ...
                // Implementasi validasi kombinasi
...
// Fungsi bantuan untuk validasi straight
...
// Fungsi bantuan untuk validasi full house
